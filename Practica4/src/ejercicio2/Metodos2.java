...
La primera Metodos2.java (donde debe estar el método main), MyMethods.java y MyMath.java. Estas dos últimas corresponden a dos clases la primera de ellas incluirá cualquier método que no sea matemático. En la clase MyMath añadiremos todos los métodos que sean matemáticos.
...
class Metodos2 {
  ...
  public static void main(String[] args) {
    ...
    // al estar los metedos en el mismo package, no haría falta importarlos
