...
Para ello proceda de la siguiente forma:
    ...
    Mediante un bucle while añada en cada iteración la letra correspondiente de la cadena original a la cadena invertida, de tal forma que en cada iteración dicha cadena tenga un carácter más. Use el método charAt() para añadir la letra que toca.
...
class InvierteCadena {
  ...
  public static void main(String[] args) {
    ...
    while (j < txt.length()) {
    	...
    	txtInvWhl += letra; // el chart pasa al superior que en este caso sería el string (Teoría)
    	j++;
    }
